...
final class ModuleFactory extends ModelFactory
{
    ...
    {
        return [
            'Enseignant' => EnseignantFactory::rendomOrCreate(), // TODO add App\Entity\enseignant type manually
            'Filiere' => FiliereFactory::rendomOrCreate(), // TODO add App\Entity\filiere type manually
            'nom' => self::faker()->text(255),
            'Semestre' => SemestreFactory::rendomOrCreate(), // TODO add App\Entity\semestre type manually
        ];
    }
