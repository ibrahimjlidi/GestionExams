...
final class NoteFactory extends ModelFactory
{
    ...
    {
        return [
            'Etudiant' => EtudiantFactory::rendomOrCreate(), // TODO add App\Entity\etudiant type manually
            'Module' => ModuleFactory::rendomOrCreate(),// TODO add App\Entity\module type manually
